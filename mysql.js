...
var createTable = function (callback) {
  ...
  client.query(sql, function (err, results) {
    ...
    var sql = "CREATE TABLE IF NOT EXISTS Entries (number bigint, name VARCHAR(255), id INTEGER NOT NULL auto_increment , createdAt DATETIME NOT NULL, updatedAt DATETIME NOT NULL, PRIMARY KEY (id)) ENGINE=InnoDB;";
    client.query(sql, function (err, results) {
      if (err) throw new Error(err)
      callback && callback()
    })
...
var testInserts = function (async, testInsertsCallback, disableLogging) {
  ...
  createTable(function () {
    ...
    var createEntry = function (callback) {
      var sql = "INSERT INTO Entries(number,name,id,createdAt,updatedAt) VALUES (" + Math.floor(Math.random() * 99999) + ",'asdasdad',NULL,'2012-01-24 16:57:51','2012-01-24 16:57:51');"
